...
(async () => {
  ...
  mustAssert(resolved === __, 'Assertion 1 Failed: The promise did not resolve as expected.', 'VGhlIHByb21pc2UgaXMgdW5mb2xkZWQu'); // "The promise is unfolded."
  ...
  mustAssert(await meditate() === __, 'Assertion 2 Failed: Await meditation incomplete.', 'VGhlIG1pbmQgc2V0dGxlcyBpbiBzaWxlbmNlLg=='); // "The mind settles in silence."
  ...
  mustAssert(waited === __, 'Assertion 3 Failed: Waiting did not resolve.', 'VGhlIG1vbWVudCBpcyBhcml2ZWQu'); // "The moment is arrived."
  ...
  mustAssert(await scrolls() === __, 'Assertion 4 Failed: Parallel knowledge not joined.', 'VGhlIHNwZWFjaGVzIG1lcmdlLg=='); // "The speeches merge."
  ...
  async function divine() {
    const res = await fetch('http://localhost:3000/divine');
    return await res.json();
  }
  const sacred = await divine();
  mustAssert(sacred.message === __, 'Assertion 5 Failed: Message from the beyond unclear.', 'VGhlIGNhbGwgaXMgaGVhcmQu'); // "The call is heard."
